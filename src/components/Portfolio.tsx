...
function Portfolio() {
  return (
    <>
      <section id="portfolio" className="w-full py-36 px-8 text-center bg-[#3E3E3E]">
        ...
        <p className="w-[90%] lg:w-[80%] mt-6 mx-auto text-sm lg:text-lg leading-6 text-[#E8DED1]">
        ...
        <div className="w-full mt-24 grid items-center grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-14 md:gap-28">
          {[...Array(6)].map((_, index) => (
            <div className="flex flex-col" key={index}>
              ...
              <p className="mt-6 text-xl text-[#B89F8B]">Lorem, ipsum dolor.</p>
            </div>
          ))}
        </div>
      </section> 
