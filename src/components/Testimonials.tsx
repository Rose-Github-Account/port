        ...
        <div className="text-white text-center">
          ...
          <div className="mt-24 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <div
                key={index}
                className="mx-auto py-8 px-2 md:px-4 border-t-[3px] border-solid border-[#A9927D] rounded-2xl select-none bg-[#1a1a1a] cursor-grab flex flex-col justify-center items-center"
              >
                <div className="w-[8rem] border-[3px] border-solid border-[#A9927D] rounded-full p-1">
                  <Image
                    src={person.src}
                    alt={person.alt}
                    width={128}
